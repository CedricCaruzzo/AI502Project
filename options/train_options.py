...
class TrainOptions:
    ...
    def initialize(self):
        ...
        self.parser.add_argument('--race_lambda', default=0, type=float,
                                 help='loss multiplier factor for race')
        ...
        self.parser.add_argument('--fine_tune', default=True, type=bool,
                                    help='Training from scratch or not')
